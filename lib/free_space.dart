...
import 'package:flutter_hostel_allocation_ui/common/common.dart';
...
import 'package:flutter_hostel_allocation_ui/modules/splash/introductionScreen.dart';
import 'package:flutter_hostel_allocation_ui/modules/splash/splashScreen.dart';
...
class FreeSpaceApp extends StatefulWidget {
  @override
  _FreeSpaceState createState() => _FreeSpaceState();
}

class _FreeSpaceState extends State<FreeSpaceApp> {
  @override
